...
class Volume extends React.Component {
    ...
    render() {
        ...
        if (interval === "now") {
            return <VolumeNow exchange={this.props.exchange} volume={this.props.volume} ws={this.props.ws} />;
        }

        return (
            <Container className="base-container">
                <Indicators
                    volume={volumeIndicators && volumeIndicators.data && volumeIndicators.data.volume}
                    symbol={symbol}
                />
